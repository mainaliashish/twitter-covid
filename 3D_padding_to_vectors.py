...
if __name__ == '__main__':
    ...
    logger_path = os.path.join('training_nodes_vectors', 'set_1', 'logger.pkl')
    training_path = os.path.join('training_nodes_vectors', 'set_1', 'direct_training_vectors.pkl')
    train_path = os.path.join('data', 'datazip', 'fold_dataset', 'set_1', 'train.csv')
    write_path = os.path.join('data', 'datazip', 'fold_dataset', 'set_1', 'train_3d_vec_full.csv')
    ...
    # test = pd.read_pickle(logger_path)
    # print(type(logger))
    # exit(0)
    ...
    new_vec = []
    for index, tokens in enumerate(train_data['Tokenize_tweet']):
