...
if __name__ == '__main__':
    ...
    train_path = os.path.join('data', 'datazip', 'fold_dataset', 'set_10', 'train_pad.csv')
    write_path = os.path.join('data', 'datazip', 'fold_dataset', 'set_10', 'train_vec_2.csv')
