...
if __name__ == '__main__':
    write_path = os.path.join('data', 'fold_train_test_dataset_overall_vectors_for_300dim')
    ...
    for n_set in range(SETS):
        ...
        write_pickle_data(os.path.join(vector_writer_joiner_path, 'train_x.pkl'), train_vectors)
        write_pickle_data(os.path.join(vector_writer_joiner_path, 'train_y.pkl'), label_vectors)
