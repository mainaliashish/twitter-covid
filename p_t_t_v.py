...
if __name__ == '__main__':
    ...
    # read_path = os.path.join('data', 'padding_tweets_tokens.csv')
    # write_path = os.path.join('data', 'words_vectors_final.csv')

    read_path = os.path.join('fold_dataset', 'set_10', 'train_pad.csv')
    write_path = os.path.join('fold_dataset', 'set_10', 'train_vector_12_300.csv')
